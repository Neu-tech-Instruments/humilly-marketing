    ...
    <footer className="bg-slate-900 text-white pt-24 pb-12">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400">
              <li><a href="/about" onClick={(e) => onPlaceholderClick(e, 'About Us')} className="hover:text-white transition-colors">About Us</a></li>
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center text-slate-500 text-sm">
          <p>© 2024 Humilly Marketing. All rights reserved.</p>
